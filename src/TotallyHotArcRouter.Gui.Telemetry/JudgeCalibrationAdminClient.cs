        ...
        IJudgeCalibrationAdminClient
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JudgeCalibrationAdminClient"/> class over a shared, already-
    ...
    public JudgeCalibrationAdminClient(CallInvoker callInvoker)
        : base(new Contract.JudgeCalibrationAdminService.JudgeCalibrationAdminServiceClient(callInvoker))
    {
    }
