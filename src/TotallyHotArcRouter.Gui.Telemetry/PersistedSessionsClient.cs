...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="PersistedSessionsClient"/> class over a shared, already-
    ...
    public PersistedSessionsClient(CallInvoker callInvoker)
        : base(new Contract.TelemetryService.TelemetryServiceClient(callInvoker))
    {
    }
