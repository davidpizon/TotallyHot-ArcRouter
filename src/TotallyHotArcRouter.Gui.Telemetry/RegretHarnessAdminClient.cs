        ...
        IRegretHarnessAdminClient
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RegretHarnessAdminClient"/> class over a shared, already-
    ...
    public RegretHarnessAdminClient(CallInvoker callInvoker)
        : base(new Contract.RegretHarnessAdminService.RegretHarnessAdminServiceClient(callInvoker))
    {
    }
