...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ClusterModelAdminClient"/> class over a shared, already-
    ...
    public ClusterModelAdminClient(CallInvoker callInvoker)
        : base(new Contract.ClusterModelAdminService.ClusterModelAdminServiceClient(callInvoker))
    {
    }
