        ...
        ILogRegModelAdminClient
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LogRegModelAdminClient"/> class over a shared, already-
    ...
    public LogRegModelAdminClient(CallInvoker callInvoker)
        : base(new Contract.RouterModelAdminService.RouterModelAdminServiceClient(callInvoker))
    {
    }
