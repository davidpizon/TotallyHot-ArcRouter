        ...
        IPriceSourceAdminClient
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PriceSourceAdminClient"/> class over a shared, already-
    ...
    public PriceSourceAdminClient(CallInvoker callInvoker)
        : base(new Contract.PriceSourceAdminService.PriceSourceAdminServiceClient(callInvoker))
    {
    }
