        ...
        ICostReconciliationAdminClient
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CostReconciliationAdminClient"/> class over a shared, already-
    ...
    public CostReconciliationAdminClient(CallInvoker callInvoker)
        : base(new Contract.CostReconciliationAdminService.CostReconciliationAdminServiceClient(callInvoker))
    {
    }
