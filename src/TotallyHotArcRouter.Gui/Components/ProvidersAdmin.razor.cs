...
public partial class ProvidersAdmin
{
    ...
    private static string LiveTrafficTip(ProviderInteractionStatusAdminView failure) =>
        failure.Kind == ProviderInteractionKindAdminView.OutOfCredits
