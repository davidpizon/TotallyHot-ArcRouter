...
public partial class PriceSourcesAdmin
{
    ...
    /// </para>
    /// </remarks>
    private async Task OnPointerDown(PriceSourceStatus source, Microsoft.AspNetCore.Components.Web.PointerEventArgs e)
    {
