...
public partial class BenchmarkData
{
    ...
    /// otherwise "Resync".
    /// </summary>
    private string ResyncLabel() => Store.IsSyncing || VoterStore.IsSyncing ? "Resyncing…" : "Resync";
    ...
    /// </summary>
    private Task RunResync() => Task.WhenAll(RunAction(), RunVoterAction());
    ...
    /// </summary>
    private string ActionLabel() => Store.Status?.State switch
    {
    ...
    /// </summary>
    private string VoterActionLabel() => VoterStore.IsSyncing ? "Updating…" : "Update";
