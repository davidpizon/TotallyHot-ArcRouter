...
/// </summary>
public sealed class SandboxWorkQueue : ISandboxQueue
{
    private readonly Channel<SandboxRequest> _channel;
    private long _droppedCount;

    /// <summary>Initializes a new instance of the <see cref="SandboxWorkQueue"/> class.</summary>
    /// <param name="options">The sandbox options carrying the queue capacity.</param>
    public SandboxWorkQueue(IOptions<SandboxOptions> options)
    {
        ...
        _channel = Channel.CreateBounded<SandboxRequest>(new BoundedChannelOptions(capacity)
        {
    ...
    /// <inheritdoc />
    public bool TryEnqueue(SandboxRequest request)
    {
    ...
    /// <inheritdoc />
    public IAsyncEnumerable<SandboxRequest> DequeueAllAsync(CancellationToken cancellationToken) =>
