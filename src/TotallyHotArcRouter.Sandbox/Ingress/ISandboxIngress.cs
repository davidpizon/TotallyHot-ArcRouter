...
/// <summary>
/// The façade the proxy calls to feed a completed response into the sandbox. It applies the sampling
...
/// </summary>
public interface ISandboxIngress
{
    ...
    void TryIngest(SandboxIngestContext context);
}

/// <summary>Inputs to <see cref="ISandboxIngress.TryIngest"/>.</summary>
...
public sealed record SandboxIngestContext(
    string ResponseText,
    string Prompt,
    string Model,
