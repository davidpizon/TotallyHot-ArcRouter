...
/// <summary>
/// A unit of work enqueued for off-path sandbox evaluation: one extracted code block plus the routing
...
/// <param name="TierHint">An optional explicit tier request; the tier selector may still override it.</param>
