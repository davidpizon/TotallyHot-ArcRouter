    ...
    IReadOnlyList<string> Errors)
{
    ...
    public static SyntaxVerdict Valid(SandboxLanguage language, bool isAuthoritative) =>
    ...
    public static SyntaxVerdict Invalid(SandboxLanguage language, bool isAuthoritative, IReadOnlyList<string> errors) =>
