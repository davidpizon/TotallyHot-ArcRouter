...
(`IRoutingVoter`) and a documented stub are in place; a future session fills in the real model. The
`logreg` placeholder-artifact deferral this paragraph originally recorded is resolved and superseded by
