...
| Auto-update Phases 0-2 — versioning source of truth, Windows Service hosting, and the Router's self-update pipeline (`GitHubReleaseCheckClient`, `UpdateCheckHostedService`, `UpdateAdminService` gRPC surface, `TotallyHotArcRouter.Updater` helper project, GUI "Software Update" section) | [`../docs/router/auto-update-plan.md`](../docs/router/auto-update-plan.md) |
