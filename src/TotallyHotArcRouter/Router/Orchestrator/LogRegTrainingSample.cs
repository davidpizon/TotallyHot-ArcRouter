...
/// <param name="ModelKey">The example's model, canonicalized via <see cref="Models.ModelNameCanonicalizer.Canonicalize(string,string?)"/> - the same keying convention <see cref="EmbeddingLogRegModelArtifact.ClassWeights"/> uses.</param>
/// <param name="Score">The observed quality score in <c>[0, 1]</c> this example contributes to <paramref name="ModelKey"/>'s regression head.</param>
/// <param name="Weight">
