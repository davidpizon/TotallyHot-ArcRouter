...
public sealed class SqliteRouterMemoryStore : IRouterMemoryStore
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        while (reader.Read())
        {
            ...
            var aggregate = new ScoreAggregate(reader.GetDouble(2), reader.GetInt32(3));

            var models = memory.GetOrAdd(dimension, static _ => new ConcurrentDictionary<string, ScoreAggregate>());
