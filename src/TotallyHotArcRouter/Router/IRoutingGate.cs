...
/// disabling routing keeps the Windows Service up and every admin/management surface (the gRPC-Web
/// admin services, MCP, <c>/v1/models</c>) fully usable; it only stops new LLM traffic
