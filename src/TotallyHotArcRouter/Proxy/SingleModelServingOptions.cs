...
/// sends, mirroring LiteLLM's <c>litellm --model provider/name</c> single-model serving mode. <see
/// langword="null"/> (the default - no CLI flag given) means normal multi-model routing, unaffected.
/// </summary>
