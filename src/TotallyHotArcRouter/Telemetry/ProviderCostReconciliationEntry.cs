...
/// <param name="ProviderReportedCostUsd">
/// The provider's own reported cost for this window, summed across every paginated
/// page.
/// </param>
/// <param name="LocalEstimatedCostUsd">
/// This proxy's locally estimated cost for the same window, summed directly from
/// <c>usage_ledger</c> (<see cref="IUsageLedger.SumEstimatedCostUsd"/>) rather than the rollup store, whose bucket
/// boundaries are timezone-pinned and would otherwise misalign with this UTC window.
/// </param>
