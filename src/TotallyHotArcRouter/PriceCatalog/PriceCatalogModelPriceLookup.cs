...
/// <summary>
/// <see cref="IModelPriceLookup"/> backed by the <see cref="PriceCatalogRepository"/>, applying the same
...
public sealed class PriceCatalogModelPriceLookup : IModelPriceLookup
{
    ...
    public PriceCatalogModelPriceLookup(PriceCatalogRepository repository)
    {
