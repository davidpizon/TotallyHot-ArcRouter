...
public sealed class ProviderAdminEndpointsTests
{
    ...
    public async Task PutBudget_PersistsCaps_AndGetSurfacesCapsAndCurrentMonthSpend()
    {
        ...
        try
        {
            ...
            await budgetStore.RecordUsageAsync("openai", 12.50m, promptTokens: 300, completionTokens: 200, cacheCreationTokens: null, cacheReadTokens: null, DateTimeOffset.UtcNow, TestContext.Current.CancellationToken);
