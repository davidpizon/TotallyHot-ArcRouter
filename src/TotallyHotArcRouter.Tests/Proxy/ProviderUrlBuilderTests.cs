...
public class ProviderUrlBuilderTests
{
    ...
    [InlineData("https://gw.corp/openai/v1", "/openai/v1/chat/completions", "",
        "https://gw.corp/openai/v1/chat/completions")]
    ...
    [InlineData("https://generativelanguage.googleapis.com/v1", "/v1beta/models", "",
        "https://generativelanguage.googleapis.com/v1/v1beta/models")]
        ...
        string expected)
    {
        Assert.Equal(expected: expected,
            actual: ProviderUrlBuilder.BuildPassthroughUrl(baseUrl: new Uri(baseUrl), requestPath: requestPath,
