...
public sealed class VoterEmbeddingModelGuardTests
{
    ...
    [
        ...
        new(ModelName: "model-b", Provider: "openai", false)
    ];
    ...
    public async Task LogRegVoter_ArtifactFromADifferentEmbeddingModel_Abstains()
    {
        var voter = new LogRegVoter(
            logger: NullLogger<LogRegVoter>.Instance,
    ...
    public async Task LogRegVoter_ArtifactFromTheSameEmbeddingModel_Votes()
    {
        var voter = new LogRegVoter(
            logger: NullLogger<LogRegVoter>.Instance,
            model: Artifact("model-a"),
            embeddingClient: new StubEmbeddingClient("model-a"));
    ...
    private static VotingContext Context()
    {
    ...
    private static EmbeddingLogRegModelArtifact Artifact(string? embeddingModel)
    {
