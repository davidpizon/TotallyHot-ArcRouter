...
public sealed class IconTests
{
    ...
    public void Renders_an_svg_for_every_known_glyph_name(string name)
    {
        ...
        var cut = ctx.Render<Icon>(p => p.Add(parameterSelector: x => x.Name, value: name));
    ...
    public void Unknown_glyph_name_renders_an_empty_svg_without_throwing()
    {
        ...
        var cut = ctx.Render<Icon>(p => p.Add(parameterSelector: x => x.Name, value: "does-not-exist"));
    ...
    public void Size_defaults_to_13_pixels()
    {
        ...
        var cut = ctx.Render<Icon>(p => p.Add(parameterSelector: x => x.Name, value: "x"));
    ...
    public void Size_class_and_style_parameters_are_forwarded()
    {
        ...
        var cut = ctx.Render<Icon>(p => p
            .Add(parameterSelector: x => x.Name, value: "x")
            .Add(parameterSelector: x => x.Size, 24)
            .Add(parameterSelector: x => x.Class, value: "my-class")
            .Add(parameterSelector: x => x.Style, value: "color:red"));
