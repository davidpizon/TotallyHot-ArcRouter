...
| **6. Hardening & docs** | Redaction of stdout/stderr in logs, resource-metric plumbing (wall-clock/peak mem), load/backpressure tests, security review of the isolation boundary, update this doc's status banner + `PLAN.md`. | Security review passed; backpressure/soak test stable; banner removed; `PLAN.md` Phase 5/verifier cross-links updated. |
