...
- `ProviderAdminClient` and `UsageQueryClient` derive from `GrpcAdminClientBase` (same 3-constructor +
  `CallAsync` + Unavailable wrapping as the Telemetry clients). Auth stays on
