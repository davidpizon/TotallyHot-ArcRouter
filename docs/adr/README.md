...
| [0012](0012-loopback-session-auth-and-token-in-secret-store.md) | Loopback session-cookie auth for the web GUI; management token moves into the encrypted secret store | accepted |
