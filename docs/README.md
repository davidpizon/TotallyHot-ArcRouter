...
| [`router/routing-roi-regret-plan.md`](router/routing-roi-regret-plan.md) | Routing ROI: expense and regret vs the frozen untrained baseline, fast drain, hard pause under load. As-built method: [`score-delta-methodology.md`](score-delta-methodology.md) | Shipped |
