...
2. Relevant xUnit v3 tests pass — `dotnet test` works directly (Microsoft.Testing.Platform, see
   `mem:suggested_commands`), or run the built `.Tests.exe` directly for faster iteration.
